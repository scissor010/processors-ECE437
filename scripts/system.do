...
add wave -noupdate -expand -group DP:buses /system_tb/DUT/CPU/DP/rfif/dmemstore
add wave -noupdate -expand -group DP:buses /system_tb/DUT/CPU/DP/rfif/dmemaddr
...
add wave -noupdate -expand -group {reg file} /system_tb/DUT/CPU/DP/rfif/wsel
add wave -noupdate -expand -group {reg file} /system_tb/DUT/CPU/DP/rfif/wdat
add wave -noupdate -expand -group {reg file} /system_tb/DUT/CPU/DP/regfile/data
...
WaveRestoreCursors {{Cursor 1} {25195 ps} 0}
...
update
WaveRestoreZoom {0 ps} {103478 ps}
